...
class CADAParameterServer(BatchUpdateParameterServer):
    def __init__(self, batch_update_size=batch_update_size, num_workers=batch_update_size, learning_rate=learning_rate, beta_1=beta_1, beta_2=beta_2, c=c, dmax=dmax):
